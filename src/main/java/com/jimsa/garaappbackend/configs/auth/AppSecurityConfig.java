...
public class AppSecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .addFilterBefore(new JWTTokenValidatorFilter(jwtUtil, userRepository, objectMapper), BasicAuthenticationFilter.class);

        httpSecurity.httpBasic(hbc -> hbc.authenticationEntryPoint(new AppAuthenticationEntryPointHandler()));
